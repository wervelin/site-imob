...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23-Jun-2021 às 22:40
...
--
-- Estrutura da tabela `categorias_dos_produtos`
--
...
--
-- Estrutura da tabela `configuracoes_api_boletos`
--
...
--
-- Extraindo dados da tabela `configuracoes_api_boletos`
--
...
--
-- Estrutura da tabela `configuracoes_do_painel`
--
...
--
-- Estrutura da tabela `controle_de_acesso`
--
...
--
-- Estrutura da tabela `equipamentos_os_provisorio`
--
...
--
-- Estrutura da tabela `historico_de_senhas`
--
...
--
-- Estrutura da tabela `inventarios_do_estoque`
--
...
--
-- Estrutura da tabela `nfes_avulsa`
--
...
--
-- Estrutura da tabela `nfe_avulsa_produtos`
--
...
--
-- Estrutura da tabela `pagamentos_da_empresa`
--
...
--
-- Estrutura da tabela `pagamentos_do_cliente`
--
...
--
-- Estrutura da tabela `pagamentos_food`
--
...
--
-- Estrutura da tabela `produtos_da_venda`
--
...
--
-- Estrutura da tabela `produtos_da_venda_rapida`
--
...
--
-- Estrutura da tabela `produtos_do_inventario_do_estoque`
--
...
--
-- Estrutura da tabela `produtos_do_orcamento`
--
...
--
-- Estrutura da tabela `produtos_do_pdv`
--
...
--
-- Estrutura da tabela `produtos_pecas_os`
--
...
--
-- Estrutura da tabela `produtos_pecas_os_provisorio`
--
...
--
-- Estrutura da tabela `provisorio_add_produto_por_xml`
--
...
--
-- Estrutura da tabela `provisorio_produtos_da_mesa_food`
--
...
--
-- Estrutura da tabela `provisorio_produtos_food`
--
...
--
-- Estrutura da tabela `provisorio_reposicao_produtos_por_xml`
--
...
--
-- Estrutura da tabela `saida_de_mercadorias`
--
...
--
-- Estrutura da tabela `servicos_mao_de_obra`
--
...
--
-- Estrutura da tabela `servicos_mao_de_obra_da_os`
--
...
--
-- Estrutura da tabela `servicos_mao_de_obra_provisorio`
--
...
--
-- Estrutura da tabela `venda_rapida`
--
...
--
-- Índices para tabela `categorias_dos_produtos`
--
...
--
-- Índices para tabela `configuracoes_api_boletos`
--
ALTER TABLE `configuracoes_api_boletos`
  ADD PRIMARY KEY (`id_config`);

--
-- Índices para tabela `configuracoes_do_painel`
--
...
--
-- Índices para tabela `controle_de_acesso`
--
...
--
-- Índices para tabela `equipamentos_os_provisorio`
--
...
--
-- Índices para tabela `historico_de_senhas`
--
...
--
-- Índices para tabela `inventarios_do_estoque`
--
...
--
-- Índices para tabela `nfes_avulsa`
--
...
--
-- Índices para tabela `nfe_avulsa_produtos`
--
...
--
-- Índices para tabela `pagamentos_da_empresa`
--
...
--
-- Índices para tabela `pagamentos_do_cliente`
--
...
--
-- Índices para tabela `pagamentos_food`
--
...
--
-- Índices para tabela `produtos_da_venda`
--
...
--
-- Índices para tabela `produtos_da_venda_rapida`
--
...
--
-- Índices para tabela `produtos_do_inventario_do_estoque`
--
...
--
-- Índices para tabela `produtos_do_orcamento`
--
...
--
-- Índices para tabela `produtos_do_pdv`
--
...
--
-- Índices para tabela `produtos_pecas_os`
--
...
--
-- Índices para tabela `produtos_pecas_os_provisorio`
--
...
--
-- Índices para tabela `provisorio_add_produto_por_xml`
--
...
--
-- Índices para tabela `provisorio_produtos_da_mesa_food`
--
...
--
-- Índices para tabela `provisorio_produtos_food`
--
...
--
-- Índices para tabela `provisorio_reposicao_produtos_por_xml`
--
...
--
-- Índices para tabela `reposicoes`
--
...
--
-- Índices para tabela `saida_de_mercadorias`
--
...
--
-- Índices para tabela `servicos_mao_de_obra`
--
...
--
-- Índices para tabela `servicos_mao_de_obra_da_os`
--
...
--
-- Índices para tabela `servicos_mao_de_obra_provisorio`
--
...
--
-- Índices para tabela `venda_rapida`
--
...
--
ALTER TABLE `caixas`
  MODIFY `id_caixa` int(9) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `configuracoes_do_painel`
  MODIFY `id_configuracao` int(9) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `controle_de_acesso`
  MODIFY `id_controle_de_acesso` int(9) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `entregadores`
  MODIFY `id_entregador` int(9) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `produtos_da_venda`
  MODIFY `id_produto_da_venda` int(9) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `produtos_da_venda_rapida`
--
ALTER TABLE `produtos_da_venda_rapida`
  MODIFY `id_produto_da_venda_rapida` int(9) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `produtos_do_pdv`
  MODIFY `id_produto_pdv` int(9) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tecnicos`
  MODIFY `id_tecnico` int(9) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `vendedores`
  MODIFY `id_vendedor` int(9) NOT NULL AUTO_INCREMENT;
...
--
-- Limitadores para a tabela `categorias_dos_produtos`
--
ALTER TABLE `categorias_dos_produtos`
...
--
-- Limitadores para a tabela `configuracoes_do_painel`
--
ALTER TABLE `configuracoes_do_painel`
...
--
-- Limitadores para a tabela `controle_de_acesso`
--
ALTER TABLE `controle_de_acesso`
...
--
-- Limitadores para a tabela `equipamentos_os_provisorio`
--
ALTER TABLE `equipamentos_os_provisorio`
...
--
-- Limitadores para a tabela `historico_de_senhas`
--
ALTER TABLE `historico_de_senhas`
...
--
-- Limitadores para a tabela `inventarios_do_estoque`
--
ALTER TABLE `inventarios_do_estoque`
...
--
-- Limitadores para a tabela `nfces`
--
ALTER TABLE `nfces`
...
--
-- Limitadores para a tabela `nfes`
--
ALTER TABLE `nfes`
...
--
-- Limitadores para a tabela `nfes_avulsa`
--
ALTER TABLE `nfes_avulsa`
...
--
-- Limitadores para a tabela `nfe_avulsa_produtos`
--
ALTER TABLE `nfe_avulsa_produtos`
...
--
-- Limitadores para a tabela `pagamentos_da_empresa`
--
ALTER TABLE `pagamentos_da_empresa`
...
--
-- Limitadores para a tabela `pagamentos_do_cliente`
--
ALTER TABLE `pagamentos_do_cliente`
...
--
-- Limitadores para a tabela `pagamentos_food`
--
ALTER TABLE `pagamentos_food`
...
--
-- Limitadores para a tabela `produtos_da_venda`
--
ALTER TABLE `produtos_da_venda`
...
--
-- Limitadores para a tabela `produtos_da_venda_rapida`
--
ALTER TABLE `produtos_da_venda_rapida`
...
--
-- Limitadores para a tabela `produtos_do_inventario_do_estoque`
--
ALTER TABLE `produtos_do_inventario_do_estoque`
...
--
-- Limitadores para a tabela `produtos_do_orcamento`
--
ALTER TABLE `produtos_do_orcamento`
...
--
-- Limitadores para a tabela `produtos_do_pdv`
--
ALTER TABLE `produtos_do_pdv`
...
--
-- Limitadores para a tabela `produtos_do_pedido`
--
ALTER TABLE `produtos_do_pedido`
...
--
-- Limitadores para a tabela `produtos_pecas_os`
--
ALTER TABLE `produtos_pecas_os`
...
--
-- Limitadores para a tabela `produtos_pecas_os_provisorio`
--
ALTER TABLE `produtos_pecas_os_provisorio`
...
--
-- Limitadores para a tabela `provisorio_add_produto_por_xml`
--
ALTER TABLE `provisorio_add_produto_por_xml`
...
--
-- Limitadores para a tabela `provisorio_produtos_da_mesa_food`
--
ALTER TABLE `provisorio_produtos_da_mesa_food`
...
--
-- Limitadores para a tabela `provisorio_produtos_food`
--
ALTER TABLE `provisorio_produtos_food`
...
--
-- Limitadores para a tabela `provisorio_reposicao_produtos_por_xml`
--
ALTER TABLE `provisorio_reposicao_produtos_por_xml`
...
--
-- Limitadores para a tabela `saida_de_mercadorias`
--
ALTER TABLE `saida_de_mercadorias`
...
--
-- Limitadores para a tabela `servicos_mao_de_obra`
--
ALTER TABLE `servicos_mao_de_obra`
...
--
-- Limitadores para a tabela `servicos_mao_de_obra_da_os`
--
ALTER TABLE `servicos_mao_de_obra_da_os`
...
--
-- Limitadores para a tabela `servicos_mao_de_obra_provisorio`
--
ALTER TABLE `servicos_mao_de_obra_provisorio`
...
--
-- Limitadores para a tabela `venda_rapida`
--
ALTER TABLE `venda_rapida`
